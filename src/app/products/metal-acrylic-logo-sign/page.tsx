          ...
          <div className="container grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            <div className="reveal visible">
              ...
              <p className="text-xl lg:text-2xl text-slate-300 mb-12 max-w-xl leading-relaxed font-medium">
                Precision laser-cut metal logos with premium acrylic layering for reception walls, boardrooms and storefronts. Museum-grade finishes engineered for a permanent brand statement.
              </p>
              <div className="flex flex-col sm:flex-row gap-6">
                <button 
                  onClick={() => handleWhatsApp("Hi Aaron, I need a quote for a Metal & Acrylic Logo Sign.")}
            ...
            <div className="reveal visible relative">
              ...
              <img src="/assets/images/cat-metal.webp" alt="Metal & Acrylic Logo Sign" className="relative rounded-[4rem] shadow-2xl border-8 border-white/5 object-cover w-full h-[600px]" />
            </div>
          </div>
        </section>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                  <div className="p-10 bg-slate-50 rounded-[3rem] border border-slate-100">
                    ...
                    <ul className="space-y-3 text-slate-600 font-bold">
                      ...
                      <li>&bull; Brushed, Mirror, or Titanium Finish</li>
                      <li>&bull; Cast Solid Acrylic (Gloss or Matte)</li>
                  ...
                  <div className="p-10 bg-slate-50 rounded-[3rem] border border-slate-100">
                    ...
                    <ul className="space-y-3 text-slate-600 font-bold">
                      <li>&bull; LED Lifetime: 50,000+ Hours (Backlit Options)</li>
                      <li>&bull; IP Rating: IP65 / IP67 (Waterproof)</li>
                      <li>&bull; Laser-Cut Tolerance: &plusmn;0.1mm</li>
