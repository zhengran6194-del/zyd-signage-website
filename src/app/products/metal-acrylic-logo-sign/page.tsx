        ...
        <section className="bg-slate-900 text-white py-20 lg:py-24 relative overflow-hidden">
          <div className="container grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div className="reveal visible relative">
              ...
              <img src="/assets/images/cat-metal.webp" alt="Metal & Acrylic Logo Sign" width={1200} height={800} loading="eager" fetchPriority="high" className="relative rounded-[2.5rem] shadow-2xl border-4 border-white/5 object-cover w-full h-[420px] lg:h-[500px]" />
            </div>
          </div>
        </section>
          ...
          <div className="container">
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 lg:gap-14">
              <div className="lg:col-span-2">
                ...
                <p className="text-slate-500 leading-relaxed mb-10 max-w-2xl font-medium">Each item is a decision input for a fabricated logo sign. Confirm the artwork, wall, and finish before production.</p>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
                  ...
                  <div className="p-8 bg-white rounded-[2rem] border border-slate-200 shadow-sm">
                    ...
                    <ul className="space-y-3 text-slate-600 font-medium">
                      <li>&bull; Optional LED backlighting using Samsung or Epistar chips</li>
                      <li>&bull; MeanWell power supplies rated IP67 where lit</li>
                      <li>&bull; Weather operation from -40°C to +60°C for exterior builds</li>
              ...
              <div className="bg-slate-950 p-10 rounded-[3rem] text-white flex flex-col justify-center shadow-2xl">
                ...
                <p className="text-slate-400 mb-8 leading-relaxed font-medium">Direct manufacturing from our 20,000sqm base in Dalian, established in 2006, keeps cutting, finishing, and assembly under one quality-control process.</p>
