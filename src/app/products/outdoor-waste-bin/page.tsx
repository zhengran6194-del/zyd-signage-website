        ...
        <section className="bg-slate-900 text-white py-20 lg:py-24 relative overflow-hidden">
          <div className="container grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div className="reveal visible relative">
              ...
              <img src="/assets/images/outdoor-waste-bin.jpg" alt="Custom outdoor waste bin with logo panel" width={843} height={843} loading="eager" fetchPriority="high" className="relative rounded-[2.5rem] shadow-2xl border-4 border-white/5 object-cover w-full h-[420px] lg:h-[500px]" />
            </div>
          </div>
        </section>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 lg:gap-14">
              <div className="lg:col-span-2">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
                  <div className="p-8 bg-slate-50 rounded-[2rem] border border-slate-100">
                    <h3 className="text-xl font-black text-blue-600 mb-4 uppercase italic">Visible Design</h3>
                    <p className="text-slate-600 font-bold leading-relaxed">Coordinate the external appearance and logo area with your project identity and site environment.</p>
                  </div>
                  <div className="p-8 bg-slate-50 rounded-[2rem] border border-slate-100">
                    <h3 className="text-xl font-black text-blue-600 mb-4 uppercase italic">Placement Planning</h3>
                    <p className="text-slate-600 font-bold leading-relaxed">Share the intended location, use case, and installation requirements for a project-specific recommendation.</p>
                  </div>
                  <div className="p-8 bg-slate-50 rounded-[2rem] border border-slate-100">
                    <h3 className="text-xl font-black text-blue-600 mb-4 uppercase italic">Brand Coordination</h3>
                    <p className="text-slate-600 font-bold leading-relaxed">Custom logo and appearance coordination are available for commercial and hospitality projects.</p>
                  </div>
                  <div className="p-8 bg-slate-50 rounded-[2rem] border border-slate-100">
                    <h3 className="text-xl font-black text-blue-600 mb-4 uppercase italic">Factory Consultation</h3>
                    <p className="text-slate-600 font-bold leading-relaxed">Confirm dimensions, materials, finish, capacity, and installation details with our engineering team before production.</p>
                  </div>
                </div>
              </div>
              <div className="bg-slate-950 p-10 rounded-[3rem] text-white flex flex-col justify-center shadow-2xl">
                ...
                <div className="space-y-5">
                  <div className="flex items-center gap-4"><span className="w-4 h-4 bg-green-500 rounded-full"></span><span className="font-bold">Custom Logo Coordination</span></div>
