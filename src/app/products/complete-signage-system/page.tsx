        ...
        <section className="bg-slate-900 text-white py-20 lg:py-24 relative overflow-hidden">
          <div className="container grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div className="reveal visible relative">
              ...
              <Image src="/assets/images/cat-system.jpg" alt="Complete Signage System" width={1000} height={1497} priority sizes="(min-width: 1024px) 50vw, 100vw" className="relative rounded-[2.5rem] shadow-2xl border-4 border-white/5 object-cover w-full h-[420px] lg:h-[500px]" />
            </div>
          </div>
        </section>
        ...
        <section className="section bg-slate-100 pt-0">
          <div className="container grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="bg-white rounded-[2.5rem] border border-slate-200 p-10 shadow-sm flex flex-col">
              ...
              <p className="text-slate-600 leading-relaxed mb-6">
                Rollouts are scheduled by site or opening date, with element groups produced and packed in the order they are needed on site. DDP delivery can be quoted into the program after the destination and cargo details are reviewed, with freight, clearance, and duties stated in the agreed scope.
              </p>
              <div className="mt-auto">
          ...
          <div className="container">
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 lg:gap-14">
              <div className="lg:col-span-2">
                ...
                <p className="text-slate-600 leading-relaxed mb-10 max-w-2xl font-medium">Each item is a decision input for a coordinated program. Confirm the scope, standards, and phasing before production.</p>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
                  ...
                  <div className="p-8 bg-white rounded-[2rem] border border-slate-200 shadow-sm">
                    ...
                    <ul className="space-y-3 text-slate-600 font-medium">
                      ...
                      <li>&bull; DDP delivery scope quoted from destination and cargo details</li>
              ...
              <div className="bg-slate-950 p-10 rounded-[3rem] text-white flex flex-col justify-center shadow-2xl">
                ...
                <p className="text-slate-300 mb-8 leading-relaxed font-medium">Direct manufacturing from our 20,000sqm base in Dalian, established in 2006, keeps every element group under one quality-control process.</p>
