          ...
          <div className="container">
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 lg:gap-14">
              <div className="lg:col-span-2">
                ...
                <p className="text-slate-500 leading-relaxed mb-10 max-w-2xl font-medium">Each option below is a decision input. Confirm the site, finish, and fabrication requirement with the project brief before production.</p>
