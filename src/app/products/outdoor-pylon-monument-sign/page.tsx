          ...
          <div className="container grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            <div className="reveal visible">
              ...
              <p className="text-xl lg:text-2xl text-slate-300 mb-12 max-w-xl leading-relaxed font-medium">
                Landmark-scale entry identification for corporate campuses, dealerships and retail destinations. Structural engineering and wind-load-tested construction for maximum presence and minimum maintenance.
              </p>
              <div className="flex flex-col sm:flex-row gap-6">
                <button 
                  onClick={() => handleWhatsApp("Hi Aaron, I need a quote for an Outdoor Pylon / Monument Sign.")}
            ...
            <div className="reveal visible relative">
              ...
              <img src="/assets/images/cat-outdoor.webp" alt="Outdoor Pylon Monument Sign" className="relative rounded-[4rem] shadow-2xl border-8 border-white/5 object-cover w-full h-[600px]" />
            </div>
          </div>
        </section>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                  <div className="p-10 bg-slate-50 rounded-[3rem] border border-slate-100">
                    ...
                    <ul className="space-y-3 text-slate-600 font-bold">
                      ...
                      <li>&bull; Structural Steel Frames &amp; Concrete Footings</li>
                      <li>&bull; Aluminum Composite Panels (ACP)</li>
                      <li>&bull; 18mm Solid Acrylic Illuminated Faces</li>
                    </ul>
                  </div>
                  <div className="p-10 bg-slate-50 rounded-[3rem] border border-slate-100">
                    ...
                    <ul className="space-y-3 text-slate-600 font-bold">
                      ...
                      <li>&bull; Wind-Load Certified Engineering</li>
