          ...
          <div className="container grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            <div className="reveal visible">
              ...
              <p className="text-xl lg:text-2xl text-slate-300 mb-12 max-w-xl leading-relaxed font-medium">
                Bespoke urban seating, planters and street-level branding that fuse architecture with the public realm. Heavy-gauge fabrication built to survive decades of public use and coastal climates.
              </p>
              <div className="flex flex-col sm:flex-row gap-6">
                <button 
                  onClick={() => handleWhatsApp("Hi Aaron, I need a quote for Custom Landscape Furniture.")}
            ...
            <div className="reveal visible relative">
              ...
              <img src="/assets/images/landscape-bench.jpg" alt="Custom Landscape Furniture" className="relative rounded-[4rem] shadow-2xl border-8 border-white/5 object-cover w-full h-[600px]" />
            </div>
          </div>
        </section>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                  <div className="p-10 bg-slate-50 rounded-[3rem] border border-slate-100">
                    ...
                    <ul className="space-y-3 text-slate-600 font-bold">
                      ...
                      <li>&bull; Hot-Dip Galvanized Steel with Powder Coat</li>
                      <li>&bull; HDPE &amp; Teak Timber Seating Options</li>
                      <li>&bull; GRC / Concrete Planter Modules</li>
                    </ul>
                  </div>
                  <div className="p-10 bg-slate-50 rounded-[3rem] border border-slate-100">
                    <h3 className="text-xl font-black text-blue-600 mb-4 uppercase italic">Technical Data</h3>
                    <ul className="space-y-3 text-slate-600 font-bold">
                      <li>&bull; Optional LED Lighting: 50,000+ Hours</li>
                      <li>&bull; IP Rating: IP65 / IP67 (Waterproof)</li>
                      <li>&bull; Load-Tested Commercial-Grade Construction</li>
                      <li>&bull; Anti-Corrosion Treatment for Coastal Sites</li>
                    </ul>
                  </div>
                </div>
              </div>
