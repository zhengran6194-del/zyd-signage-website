          ...
          <div className="container grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            <div className="reveal visible">
              ...
              <p className="text-xl lg:text-2xl text-slate-300 mb-12 max-w-xl leading-relaxed font-medium">
                End-to-end directional signage for airports, hospitals, campuses and mixed-use developments. Engineered to international accessibility standards with precision aluminum and stainless construction.
              </p>
              <div className="flex flex-col sm:flex-row gap-6">
                <button 
                  onClick={() => handleWhatsApp("Hi Aaron, I need a quote for an Architectural Wayfinding System.")}
            ...
            <div className="reveal visible relative">
              ...
              <img src="/assets/images/hero-wayfinding.png" alt="Architectural Wayfinding System" className="relative rounded-[4rem] shadow-2xl border-8 border-white/5 object-cover w-full h-[600px]" />
            </div>
          </div>
        </section>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                  <div className="p-10 bg-slate-50 rounded-[3rem] border border-slate-100">
                    ...
                    <ul className="space-y-3 text-slate-600 font-bold">
                      ...
                      <li>&bull; Powder-Coated Aluminum Extrusions</li>
                      <li>&bull; Tempered Glass with Anti-Fingerprint Finish</li>
                  ...
                  <div className="p-10 bg-slate-50 rounded-[3rem] border border-slate-100">
                    ...
                    <ul className="space-y-3 text-slate-600 font-bold">
                      <li>&bull; LED Lifetime: 50,000+ Hours (Illuminated Units)</li>
                      <li>&bull; IP Rating: IP65 / IP67 (Waterproof)</li>
                      <li>&bull; ADA &amp; ISO 7010-Compliant Pictograms</li>
                      <li>&bull; Braille &amp; Tactile Lettering Available</li>
                    </ul>
                  </div>
                </div>
              </div>
