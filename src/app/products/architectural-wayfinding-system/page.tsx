        ...
        <section className="bg-slate-900 text-white py-20 lg:py-24 relative overflow-hidden">
          <div className="container grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div className="reveal visible relative">
              ...
              <img src="/assets/images/hero-wayfinding.png" alt="Architectural Wayfinding System" width={1200} height={800} loading="eager" fetchPriority="high" className="relative rounded-[2.5rem] shadow-2xl border-4 border-white/5 object-cover w-full h-[420px] lg:h-[500px]" />
            </div>
          </div>
        </section>
          ...
          <div className="container">
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 lg:gap-14">
              <div className="lg:col-span-2">
                ...
                <p className="text-slate-500 leading-relaxed mb-10 max-w-2xl font-medium">Each item is a decision input for a wayfinding program. Confirm the journey, mounting, and accessibility requirement before production.</p>
              ...
              <div className="bg-slate-950 p-10 rounded-[3rem] text-white flex flex-col justify-center shadow-2xl">
                ...
                <p className="text-slate-400 mb-8 leading-relaxed font-medium">Direct manufacturing from our 20,000sqm base in Dalian, established in 2006, keeps panel fabrication and finishing under one quality-control process.</p>
