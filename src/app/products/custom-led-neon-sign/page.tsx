          ...
          <div className="container grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            <div className="reveal visible">
              ...
              <p className="text-xl lg:text-2xl text-slate-300 mb-12 max-w-xl leading-relaxed font-medium">
                High-visibility neon flex logos for retail windows, hospitality interiors and events. Ultra-bright flexible tubing with a glass-like glow — shatterproof, low-power and fully customizable.
              </p>
              <div className="flex flex-col sm:flex-row gap-6">
                <button 
                  onClick={() => handleWhatsApp("Hi Aaron, I need a quote for a Custom LED Neon Sign.")}
            ...
            <div className="reveal visible relative">
              ...
              <img src="/assets/images/cat-neon.webp" alt="Custom LED Neon Sign" className="relative rounded-[4rem] shadow-2xl border-8 border-white/5 object-cover w-full h-[600px]" />
            </div>
          </div>
        </section>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                  <div className="p-10 bg-slate-50 rounded-[3rem] border border-slate-100">
                    ...
                    <ul className="space-y-3 text-slate-600 font-bold">
                      <li>&bull; #304 / #316 Stainless Steel Mounting Frames</li>
                      <li>&bull; 12-14mm Silicone Neon Flex (Shatterproof)</li>
                      <li>&bull; Solid Acrylic Backers &amp; Standoffs</li>
                  ...
                  <div className="p-10 bg-slate-50 rounded-[3rem] border border-slate-100">
                    ...
                    <ul className="space-y-3 text-slate-600 font-bold">
                      ...
                      <li>&bull; Input Voltage: DC 12V / 24V (Low Power)</li>
