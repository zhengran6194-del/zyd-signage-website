...
const faqs = [
  { q: 'Can you provide free 3D mockups?', a: 'Our engineering team can provide a 3D mockup for a project inquiry when the brief contains enough information to prepare one. The scope and format are confirmed with the project before production.' },
  ...
  { q: 'What is the minimum order quantity for custom signage?', a: 'The minimum order quantity (MOQ) is 1 piece for the listed custom signage products. Your quotation can cover one sign or a larger project quantity, depending on the brief.' },
  { q: 'What information do you need to prepare a signage quotation?', a: 'Please provide the artwork, approximate dimensions, quantity, finish, lighting requirement, and ship-to destination. These inputs help define the fabrication and delivery scope instead of relying on a headline estimate.' },
  { q: 'How much does custom signage cost?', a: 'There is no single price for custom signage because the scope varies by artwork, dimensions, quantity, materials and finish, lighting, packing, shipping, and installation responsibility. Share those project inputs so the quotation can describe a comparable scope.' },
  { q: 'How should I choose materials for an outdoor sign?', a: 'Material selection should follow the project environment and design brief, including exposure, appearance, finish, fabrication, drainage, cleaning access, and maintenance. The right choice is project-specific rather than a universal material recommendation.' },
  { q: 'What information is needed for a DDP shipping quotation?', a: 'DDP (Delivered Duty Paid) is a door-to-door delivery model that includes import duties and taxes within the agreed delivery scope. Freight and duties must be calculated from the destination and cargo details, so please share the ship-to location, dimensions, quantity, and other available project information.' },
  { q: 'What is the standard lead time?', a: 'Typical production lead time is 7–14 days depending on project complexity, artwork, quantity, and finish. Large-scale rollout projects are phased according to your schedule.' },
  { q: 'Do you provide detailed installation drawings?', a: 'Installation templates and technical drawings can be prepared when they are included in the project scope. They show the agreed mounting points and electrical connections for the specified sign.' },
  { q: 'What is International DDP Shipping?', a: 'DDP (Delivered Duty Paid) is a door-to-door delivery model in which the agreed delivery scope includes import clearance, duties, and taxes. Availability and the delivered scope are quoted from the destination and cargo details.' },
  { q: 'Are your signs durable in coastal environments?', a: 'Coastal projects need a material and finish review based on exposure, appearance, fabrication, drainage, cleaning access, and maintenance. 304 stainless steel or another route may be considered when it fits the confirmed project brief; no material is a universal guarantee against corrosion.' },
  { q: 'What are your warranty terms?', a: 'Any warranty coverage, duration, and exclusions are stated in the project quotation or supply agreement. They depend on the supplied scope and should be confirmed before production.' },
